...
describe("reply-listener", () => {
  ...
  describe("Injection feedback", () => {
    ...
    it("Discord feedback includes message_reference in source", () => {
      ...
      // Channel notification includes message_reference to reply to user's message
